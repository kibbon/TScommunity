...
class DiscussionsControllerTest < ActionController::TestCase
  ...
  test "should create discussion" do
    assert_difference('Discussion.count') do
      post :create, discussion: { content: @discussion.content, projection_id: @discussion.projection_id, user_id: @discussion.user_id }
    end
  ...
  test "should update discussion" do
    patch :update, id: @discussion, discussion: { content: @discussion.content, projection_id: @discussion.projection_id, user_id: @discussion.user_id }
    assert_redirected_to discussion_path(assigns(:discussion))
  end
